...
def fleshify(request, patientid, section, section_url, field_vars):
    ...
    if request.is_ajax():
        ...
        return render_to_response('dashboard/main.html', field_vars, context_instance=RequestContext(request))
...
def history(request, patientid):
    ...
    return fleshify(request, patientid, "history", "dashboard/sections/history.html", field_vars)
...
def calendar(request, patientid):
    ...
    return fleshify(request, patientid, "calendar", "dashboard/sections/calendar.html", field_vars)
...
def dispatch(request, patientid, section):
    if section == "processes":
        ...
        return history(request, patientid)
    elif section == "calendar":
        return calendar(request, patientid)
